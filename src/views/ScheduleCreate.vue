<template>
    <div id="schedule-create">
        ...
        <button @click="saveSchedule" class="purple-btn btn-size-m font-size-s">저장</button>
    </div>
</template>
            ...
            if(this.isCheckedSchedule()) {
                ...
                .post(
                    "/schedule/tune-range",
                    {
                        ...
                        startDate: this.calendarOptions.events[1].start,
                        endDate: this.calendarOptions.events[1].end,
                        startTime: "09:00",
                        endTime: "21:00",
                        placeTuneState: false,
                    }
                )
                .then(res => {
